<?php
namespace <%- props.appName %>\Core\Database\Eloquent;
...
class Database extends \Illuminate\Database\Connection
{
    ...
    public function __construct()
    {
        ...
        $this->schemaGrammar = new \Illuminate\Database\Schema\Grammars\MySqlGrammar;
        $this->schemaGrammar->setTablePrefix($this->db->prefix);
    }
    ...
    public function select($query, $bindings = array())
    {
        ...
        dd($bindings);
        if (isset($bindings[0])) {
            $bindings = array('wp_pinkorchild', $bindings[0]);
        }
        $query          = $this->bind_params( $query, $bindings );
